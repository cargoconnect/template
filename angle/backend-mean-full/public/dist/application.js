    ...
    angular
        ...
        .constant('APP_REQUIRES', {
          ...
          modules: [
            ...
            {name: 'ngGrid',                    files: ['/lib/ng-grid/build/ng-grid.min.js',
                                                        '/lib/ng-grid/ng-grid.css' ]},
            ...
            {name: 'angularGrid',               files: ['/lib/ag-grid/dist/angular-grid.css',
    ...
    function appRoutes($stateProvider, helper) {
        ...
        $stateProvider
            ...
            .state('app.table-nggrid', {
                url: '/table/nggrid',
                templateUrl: 'modules/tables/views/table-ng-grid.client.view.html',
